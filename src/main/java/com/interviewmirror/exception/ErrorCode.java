...
public enum ErrorCode {
  ...
  INTERNAL_SERVER_ERROR(
    ...
    NETWORK_DISCONNECTED(HttpStatus.SERVICE_UNAVAILABLE, "NETWORK_DISCONNECTED", "네트워크 연결이 끊어졌습니다. 재연결을 시도해주세요."), // WebSocket 연동시 활용
    ...
    INTERNAL_COMMUNICATION_ERROR(HttpStatus.INTERNAL_SERVER_ERROR, "INTERNAL_COMMUNICATION_ERROR", "내부 통신 중 오류가 발생했습니다.");
