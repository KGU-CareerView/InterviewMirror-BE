...
public class FeedbackBufferRepository {
    ...
    public void appendAll(String sessionId, Collection<FeedbackResponse> responses) {
        ...
        List<String> payloads = responses.stream()
                .map(this::serialize)
                .toList();
    ...
    private String serialize(FeedbackResponse response) {
        try {
            ...
            throw new BusinessException("Failed to serialize feedback response", "FEEDBACK_SERIALIZE_FAILED");
        }
    }
    ...
    private FeedbackResponse deserialize(String payload) {
        try {
            ...
            throw new BusinessException("Failed to deserialize feedback response", "FEEDBACK_DESERIALIZE_FAILED");
        }
    }
}
