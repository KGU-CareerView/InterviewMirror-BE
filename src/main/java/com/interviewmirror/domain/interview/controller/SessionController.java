...
public class SessionController {
  ...
  public ResponseEntity<SessionStateResponse> getSessionState(
    ...
    return ResponseEntity.ok(SessionStateResponse.builder().sessionState(state).build());
  }
  ...
  public ResponseEntity<PresignedUrlResponse> getPresignedUrl(
    ...
    return ResponseEntity.ok(PresignedUrlResponse.builder().presignedUrl(presignedUrl).build());
  }
