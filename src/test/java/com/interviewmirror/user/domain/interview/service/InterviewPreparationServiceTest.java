...
class InterviewPreparationServiceTest {
    ...
    @Mock
    private InterviewSettingRepository settingRepository;
    ...
    void saveSetting_Success() {
        ...
        InterviewSettingRequest request = new InterviewSettingRequest(
                1L, "BACKEND", "TECH", "NORMAL", 5, 120, "Spring Boot 경험..."
        );

        InterviewSetting mockSavedSetting = InterviewSetting.builder()
                .userId(1L)
                .category("BACKEND")
                .interviewType("TECH")
                .difficulty("NORMAL")
        ...
        verify(aiGrpcClient, times(1)).requestInitialQuestions(
                "BACKEND", "TECH", "NORMAL", 5, "Spring Boot 경험..."
        );
    }
