...
public enum ErrorCode {
  ...
  REALTIME_FRAME_FAILED(
      HttpStatus.INTERNAL_SERVER_ERROR, "REALTIME_FRAME_FAILED", "실시간 프레임 분석에 실패했습니다."),
  REALTIME_COMPLETE_FAILED(
      HttpStatus.INTERNAL_SERVER_ERROR, "REALTIME_COMPLETE_FAILED", "실시간 세션 완료 처리에 실패했습니다."),
  REALTIME_STREAM_SEND_FAILED(
      HttpStatus.INTERNAL_SERVER_ERROR,
      "REALTIME_STREAM_SEND_FAILED",
      "AI 서버로 실시간 프레임 전송에 실패했습니다."),
  AI_STREAM_FAILED(HttpStatus.INTERNAL_SERVER_ERROR, "AI_STREAM_FAILED", "AI 분석 스트림 처리에 실패했습니다."),
  REALTIME_SERIALIZE_FAILED(
      HttpStatus.INTERNAL_SERVER_ERROR, "REALTIME_SERIALIZE_FAILED", "실시간 응답 직렬화에 실패했습니다."),
  REALTIME_DESERIALIZE_FAILED(
      HttpStatus.INTERNAL_SERVER_ERROR, "REALTIME_DESERIALIZE_FAILED", "실시간 응답 역직렬화에 실패했습니다."),
