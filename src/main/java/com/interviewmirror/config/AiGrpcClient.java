...
import com.interviewmirror.grpc.AiServiceGrpc;
...
public class AiGrpcClient {
  ...
  public String generateNextQuestion(Long sessionId, String answer) {
    ...
    QuestionRequest request =
        QuestionRequest.newBuilder().setSessionId(sessionId).setAnswer(answer).build();
  ...
  public String analyzeEmotion(Long sessionId, String faceData) {
    ...
    EmotionRequest request =
        EmotionRequest.newBuilder().setSessionId(sessionId).setFaceData(faceData).build();
  ...
  public List<String> requestInitialQuestions(
    ...
    InitialQuestionRequest request =
        InitialQuestionRequest.newBuilder()
